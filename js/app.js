/* ============================================================
 * app.js —— 侯康峰 · 个人档案库 主逻辑
 * 数据流：本地服务 /api/data 或内嵌 EMBEDDED_DATA（只读模式）
 * ============================================================ */
"use strict";
...
const App = {
  DATA: null,
  readonly: true,          // true = 云端/离线只读版（隐藏管理）
  charts: {},              // 惰性图表缓存
  portFilter: "全部",
  blogCat: "全部",
  blogQ: "",
  ...
  defaultData() {
    return {
      profile: { name: "侯康峰", title: "项目财务管理 · 报表统筹 · 业财融合", taglines: ["欢迎访问我的档案库"], summary: "", phone: "", email: "", location: "", company: "" },
      about: { intro: "", education: [], certificates: [], hobbies: [] },
      stats: [], skills: [], radar: { indicators: [], values: [] },
      experience: [], timeline: [], portfolio: [], blog: [],
      locations: [], settings: {}
    };
  },
  ...
  /* 保存到本地服务 */
  async save() {
    if (App.readonly) { toast("只读模式（云端版）无法保存，请用「启动网站.bat」打开本地版", "err"); return; }
    try {
